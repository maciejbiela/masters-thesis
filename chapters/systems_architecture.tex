...
\paragraph{}
Assuming a successful preprocessing phase, in the actual computing phase the input images contain only the surfaces of the splints (see figure \ref{fig:preprocessing_outputs}).
